...
export interface ApiApplicantApplicant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    agreements: Schema.Attribute.Component<
      'agreements.agreement-confirmation',
      false
    >;
    ...
    > &
      Schema.Attribute.DefaultTo<'applicationSubmitted'>;
    availability: Schema.Attribute.Component<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    experience: Schema.Attribute.Component<'experience.work-experience', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
